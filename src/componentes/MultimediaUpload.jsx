          ...
          {multimedia.map((file, index) => (
            <div key={index} className="multimedia-item">
              <div className="media-preview">
                {file.tipo === 'video' ? (
                  <video src={file.url} controls className="media-thumbnail" preload="metadata">
              ...
              <div className="media-info">
                ...
                {file.bytes && <span className="media-size">{formatFileSize(file.bytes)}</span>}
                {file.duration && (
                  <span className="media-duration">{Math.floor(file.duration)}s</span>
                )}
              </div>
            </div>
          ))}
